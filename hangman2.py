...
def main():
    welcome = ['Welcome to Hangman! A word will be chosen at random and',
               ...
               'before you run out of attempts. Good luck punk, youre gonna need it!'
               ]
    ...
    while play_again:
        ...
        words = ["hangman", "chairs", "backpack", "bodywash", "",
                 "computer", "python", "program", "glasses", "sweatshirt",
                 "sweatpants", "mattress", "gathering", "clocks", "biology",
                 "algebra", "suitcase", "knives", "ninjas", "shampoo", "magic",
                 "twofish", "snowboard", "florida", "leoploradon"
                 ]
...
""")
        ...
        if "-" not in word_guessed: # no blanks remaining
            print(("\nCongratulations! {} was the word YOU GET TO LIVE").format(chosen_word))
        else: # loop must have ended because attempts reached 0
            print(("\nUnlucky! The word was {}. Say Sayonara compadre!").format(chosen_word))

        print("\nWould you like to risk your life some more?")
